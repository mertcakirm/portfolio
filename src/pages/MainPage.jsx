    ...
    return (
        <div className="main-page-parent-con">
            ...
            <div className="container p-5">
                    ...
                    mainItem.map((item, index) => (
                        <div key={index} className="row justify-content-center">
                            <div className="col-lg-8 col-12 py-5">
                                <p data-aos="fade-right" className="titles">
                                    {language === "tr" ? item.header_tr : item.header_en}
                                </p>
                                <p data-aos="fade-right" className="normal-text">
                ...
                <div data-aos="fade-up" className="row justify-content-center justify-content-lg-between mt-3 px-0 mx-0 row-gap-3 col-12">
                    <p className="titles col-12">{language === "tr" ? "EĞİTİMLERİM 📒" : "EDUCATİONS 📒"}</p>
                    {educations.map((item, index) => (
                        <div key={index} className="col-lg-6 col-12  row col-12">
                ...
                <div data-aos="fade-up" className="col-12  py-5 px-0 mx-0 row">
                ...
                <div data-aos="fade-up" className="col-12 mb-5 row py-5 px-0 mx-0">
